package com.oyamo.dooka_app.feature_wish_list.data.mapper

import com.oyamo.dooka_app.feature_products.domain.model.Product
import com.oyamo.dooka_app.feature_wish_list.data.local.RatingEntity
import com.oyamo.dooka_app.feature_wish_list.data.local.WishlistEntity
import com.oyamo.dooka_app.feature_wish_list.domain.model.Rating
...
internal fun Rating.toProductRating(): com.oyamo.dooka_app.feature_products.domain.model.Rating {
    return com.oyamo.dooka_app.feature_products.domain.model.Rating(
        count = count,
        rate = rate
    )
}

internal fun com.oyamo.dooka_app.feature_products.domain.model.Rating.toWishlistRating(): Rating {
    return Rating(
        count = count,
        rate = rate
    )
